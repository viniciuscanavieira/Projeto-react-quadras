...
// Função para fechar o modal com tipo explícito para 'index'
const handleCloseModal = (index: number): void => {
  ...
  <div className="d-flex justify-content-center mt-3">
    ...
    <Button variant="danger" onClick={() => setConfirm(false)}>Cancelar</Button>
      ...
      {servicos.map((servico, index) => (
  <Modal key={index} show={selectedModalIndex === index} onHide={() => handleCloseModal(index)}>
    <Modal.Header closeButton>
    ...
    <Modal.Footer>
      <Button variant="secondary" onClick={() => handleCloseModal(index)}>Fechar</Button>
    </Modal.Footer>
  </Modal>
